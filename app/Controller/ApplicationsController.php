 ...
 */
	public function add() {
		...
		$students = $this->Application->Student->find('list');
		$jobpostings = $this->Application->Jobposting->find('list');
		$applicationstatuses = $this->Application->Applicationstatus->find('list');
		$this->set(compact('students', 'jobpostings', 'applicationstatuses'));
	}
