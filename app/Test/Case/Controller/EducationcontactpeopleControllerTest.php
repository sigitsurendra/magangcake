<?php
App::uses('EducationcontactpeopleController', 'Controller');

/**
 * EducationcontactpeopleController Test Case
 *
 */
class EducationcontactpeopleControllerTest extends ControllerTestCase {
