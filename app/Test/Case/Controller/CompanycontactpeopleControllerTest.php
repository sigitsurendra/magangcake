<?php
App::uses('CompanycontactpeopleController', 'Controller');

/**
 * CompanycontactpeopleController Test Case
 *
 */
class CompanycontactpeopleControllerTest extends ControllerTestCase {
