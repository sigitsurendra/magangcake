<?php
App::uses('ApplicationstatusesController', 'Controller');

/**
 * ApplicationstatusesController Test Case
 *
 */
class ApplicationstatusesControllerTest extends ControllerTestCase {
