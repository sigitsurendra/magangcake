<?php
App::uses('EducationorganizationsController', 'Controller');

/**
 * EducationorganizationsController Test Case
 *
 */
class EducationorganizationsControllerTest extends ControllerTestCase {
