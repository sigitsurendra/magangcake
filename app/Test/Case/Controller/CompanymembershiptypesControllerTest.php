<?php
App::uses('CompanymembershiptypesController', 'Controller');

/**
 * CompanymembershiptypesController Test Case
 *
 */
class CompanymembershiptypesControllerTest extends ControllerTestCase {
