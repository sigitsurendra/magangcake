<?php
App::uses('StudentorganizationsController', 'Controller');

/**
 * StudentorganizationsController Test Case
 *
 */
class StudentorganizationsControllerTest extends ControllerTestCase {
