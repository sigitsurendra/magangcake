<?php
App::uses('CompanymembershipsController', 'Controller');

/**
 * CompanymembershipsController Test Case
 *
 */
class CompanymembershipsControllerTest extends ControllerTestCase {
