<?php
App::uses('IndustrycategoriesController', 'Controller');

/**
 * IndustrycategoriesController Test Case
 *
 */
class IndustrycategoriesControllerTest extends ControllerTestCase {
