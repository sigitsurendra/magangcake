<?php
App::uses('EducationcategoriesController', 'Controller');

/**
 * EducationcategoriesController Test Case
 *
 */
class EducationcategoriesControllerTest extends ControllerTestCase {
