<?php
App::uses('OrganizationexperiencesController', 'Controller');

/**
 * OrganizationexperiencesController Test Case
 *
 */
class OrganizationexperiencesControllerTest extends ControllerTestCase {
