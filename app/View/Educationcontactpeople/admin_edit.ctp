...
<?php echo $this->Form->create('Educationcontactperson'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Educationcontactperson'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Educationcontactperson.idEducationContactPerson')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Educationcontactperson.idEducationContactPerson'))); ?></li>
