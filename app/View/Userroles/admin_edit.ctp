...
<?php echo $this->Form->create('Userrole'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Userrole'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Userrole.idUser, idRole')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Userrole.idUser, idRole'))); ?></li>
