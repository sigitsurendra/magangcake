...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Student.idStudent')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Student.idStudent'))); ?></li>
